...
router.post('/me/stories/drafts', authenticated, userController.getDraftStory)
router.post('/me/stories/public', authenticated, userController.getPublishedStory)
router.post('/me/stories/responses', authenticated, userController.getResponses)
